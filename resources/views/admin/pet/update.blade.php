    ...
    <div class="form-check">
        <form action="{{route('pet.update',$pet->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3 align-items-center">
                ...
                <div class="col-auto">
                    <input name="name" type="text" id="inputPassword6" class="form-control" aria-describedby="passwordHelpInline" value="{{ $pet->name }}">
                </div>
                @if($errors->get("name"))
                ...
                <div class="col-auto">
                    <input name="price" type="number" id="inputPassword6" class="form-control" aria-describedby="passwordHelpInline" value="{{ $pet->price }}">
                </div>
                @if($errors->get("price"))
                ...
                <div class="col-auto">
                    <input name="sale_price" type="number" id="inputPassword6" class="form-control" aria-describedby="passwordHelpInline" value="{{ $pet->sale_price  }}">
                </div>
                <div class="col-auto">
                ...
                <input name="description" id="" value="{{$pet->description}}">
